...
export class StockItemModel {
  static async findAll(): Promise<StockItemWithCategory[]> {
    const query = `
      SELECT 
  ...
  static async findById(id: string): Promise<StockItemWithCategory | null> {
    const query = `
      SELECT 
        si.id, si.name, si.description, si.category_id as "categoryId",
        si.sku, si.barcode, si.unit_of_measure as "unitOfMeasure",
  ...
  static async findByCategory(categoryId: string): Promise<StockItemWithCategory[]> {
    const query = `
      SELECT 
        si.id, si.name, si.description, si.category_id as "categoryId",
        si.sku, si.barcode, si.unit_of_measure as "unitOfMeasure",
  ...
  static async findBySku(sku: string): Promise<StockItemWithCategory | null> {
    const query = `
      SELECT 
        si.id, si.name, si.description, si.category_id as "categoryId",
        si.sku, si.barcode, si.unit_of_measure as "unitOfMeasure",
  ...
  static async findLowStock(): Promise<StockItemWithCategory[]> {
    const query = `
      SELECT 
        si.id, si.name, si.description, si.category_id as "categoryId",
        si.sku, si.barcode, si.unit_of_measure as "unitOfMeasure",
  ...
  static async create(itemData: CreateStockItemData): Promise<StockItem> {
    const query = `
  ...
  static async update(id: string, itemData: UpdateStockItemData): Promise<StockItem | null> {
    const fields = []
    const values = []
    let paramCount = 1
  ...
  static async search(query: string): Promise<StockItemWithCategory[]> {
    const searchQuery = `
      SELECT 
        si.id, si.name, si.description, si.category_id as "categoryId",
        si.sku, si.barcode, si.unit_of_measure as "unitOfMeasure",
  ...
  static async getCategoryStockSummary(): Promise<any[]> {
    const query = `
      SELECT 
        sc.id,
