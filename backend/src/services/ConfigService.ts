...
export class ConfigService {
  ...
  public getConfigSummary(): {
    environment: string
    databases: { postgresql: boolean; mongodb: boolean }
    services: { dataSync: boolean; backup: boolean; performanceMonitoring: boolean }
    security: { jwt: boolean; cors: boolean; helmet: boolean }
  } {
    return {
